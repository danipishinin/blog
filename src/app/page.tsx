...
export default function HomePage() {
  return (
    <div className="flex flex-col gap-6">
      <p className="text-sm">
        Bulding ideas, one pixel at time. <br />
        Currently working full-time as a Mobile Software Engineer at{" "}
        <a href="https://wellhub.com" target="_blank">
        ...
        <div className="flex flex-col justify-center gap-4 max-sm:items-center">
          <div className="group -m-8 flex select-all items-center gap-3 p-8 transition-all">
            ...
            <div className="inline-flex items-center gap-3">
              ...
              <a
                href="mailto:daniele.pishinin@usp.br"
